...
class Workshops_CPT {
    ...
    public function register_workshops_taxonomy() {
        $category_labels = array(
            ...
            'parent_item'                => __( 'Parent Category', 'buddyboss-wc' ),
            'parent_item_colon'          => __( 'Parent Category:', 'buddyboss-wc' ),
            'new_item_name'              => __( 'New Category Name', 'buddyboss-wc' ),
            'add_new_item'               => __( 'Add New Category', 'buddyboss-wc' ),
            'edit_item'                  => __( 'Edit Category', 'buddyboss-wc' ),
            'update_item'                => __( 'Update Category', 'buddyboss-wc' ),
            'view_item'                  => __( 'View Category', 'buddyboss-wc' ),
            ...
            'popular_items'              => __( 'Popular Categorys', 'buddyboss-wc' ),
            'search_items'               => __( 'Search Categorys', 'buddyboss-wc' ),
            'not_found'                  => __( 'Category Not Found', 'buddyboss-wc' ),
            'no_terms'                   => __( 'No genres', 'buddyboss-wc' ),
            'items_list'                 => __( 'Categorys list', 'buddyboss-wc' ),
            'items_list_navigation'      => __( 'Categorys list navigation', 'buddyboss-wc' ),
        );
        $category_args = array(
        ...
        $location_labels = array(
            ...
            'parent_item'                => __( 'Parent Location', 'buddyboss-wc' ),
            'parent_item_colon'          => __( 'Parent Location:', 'buddyboss-wc' ),
            'new_item_name'              => __( 'New Location Name', 'buddyboss-wc' ),
            'add_new_item'               => __( 'Add New Location', 'buddyboss-wc' ),
            'edit_item'                  => __( 'Edit Location', 'buddyboss-wc' ),
            'update_item'                => __( 'Update Location', 'buddyboss-wc' ),
            'view_item'                  => __( 'View Location', 'buddyboss-wc' ),
            'separate_items_with_commas' => __( 'Separate location with commas', 'buddyboss-wc' ),
            'add_or_remove_items'        => __( 'Add or remove location', 'buddyboss-wc' ),
            'choose_from_most_used'      => __( 'Choose from the most used location', 'buddyboss-wc' ),
            'popular_items'              => __( 'Popular Location', 'buddyboss-wc' ),
            'search_items'               => __( 'Search Location', 'buddyboss-wc' ),
            'not_found'                  => __( 'Location Not Found', 'buddyboss-wc' ),
            'no_terms'                   => __( 'No location', 'buddyboss-wc' ),
            'items_list'                 => __( 'Location list', 'buddyboss-wc' ),
            'items_list_navigation'      => __( 'Location list navigation', 'buddyboss-wc' ),
        );
        $location_args = array(
